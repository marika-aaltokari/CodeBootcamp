...
$("#saving").click(function () {
    ...
    //console.log(etunimi + sukunimi + kirjanNimi + suosikki + päivämäärä);
    ...
    alert("The new read book is saved. Kirjailija : " + etunimi + "," + sukunimi + "." +
        "Kirja: " + kirjanNimi + "." + "Suosikki :" + suosikki + "," + "Luettu:" + päivämäärä);
